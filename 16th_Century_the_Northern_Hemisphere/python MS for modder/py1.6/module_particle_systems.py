...
##    ),
##
## ZZ change for Cinematic Compilation  
...
## ZZ change for Cinematic Compilation     
    ...
    ("game_hoof_dust_snow", psf_billboard_3d|psf_randomize_size, "prt_mesh_snow_dust_1",#prt_mesh_dust_1
     6, 3, 3.5, 1, 10.0, 0.0, #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.2, 1), (1, 1),        #alpha keys
     (0, 1), (1, 1),        #red keys
     (0, 1),(1, 1),         #green keys
     (0, 1),(1, 1),         #blue keys
     (0.5, 4),   (1.0, 7),   #scale keys
...
## ZZ gun fire    Yifeng change

#   ("musket_smoke", psf_billboard_3d, "prtcl_dust_a",
#    90, 3.0, 0.5, 0, 50.0, 1.5,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
...
#     40, 0.5, 0.4, 0, 5.0, 0.5,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
#     (0.0, 0.75), (1, 0),       #alpha keys
#     (0.0, 0.23), (1, 0.22),      #red keys
#     (0.0, 0.1),(1, 0.22),       #green keys
#     (0.0, 0.1), (1, 0.17),      #blue keys
#     (0.2, 0.5), (0.0, 0.2),   #scale keys
#     (0.0, 0.1, 0.1),           #emit box size
#     (0.0, 2.0, 0),                 #emit velocity
#     0.05                        #emit dir randomness
#    ),
#Yifeng change
        ("musket_ogon", psf_billboard_3d, "prt_mesh_fire_1",
...
#     90, 0.3, 0.6, 0, 10.0, 0.5,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
#     (0.0, 0.75), (1, 0),       #alpha keys
#     (0.0, 0.23), (1, 0.22),      #red keys
#     (0.0, 0.1),(1, 0.17),       #green keys
#     (0.0, 0.03), (1, 0),      #blue keys

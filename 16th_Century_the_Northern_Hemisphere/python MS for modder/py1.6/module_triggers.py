...
triggers = [
  ...
  (0.2, 0, ti_once, [(map_free,0)], [
	(call_script, "script_mod_set_default"),
	(call_script,"script_ini_mod_castle"),
  ]),

  
# Tutorial:
  (0.1, 0, ti_once, [(map_free,0)], [(dialog_box,"str_tutorial_map1")]),
  (0.1, 0, ti_once, [(map_free,0)], [(dialog_box,"str_tutorial_mod")]),
...
#yifeng
			(this_or_next|eq, ":cur_template", "pt_african_tribesman"),
			(this_or_next|eq, ":cur_template", "pt_wokou"),
			(this_or_next|eq, ":cur_template", "pt_indu"),
			(this_or_next|eq, ":cur_template", "pt_indian"),
...
## ZZ Sea Battle end  
##ZZ 16th war fog trigger
   (0.1, 0, 0,
    [(eq,"$disable_war_fog",0),],
    [
      (try_for_range, ":party_no", towns_begin, yifeng_party_end),

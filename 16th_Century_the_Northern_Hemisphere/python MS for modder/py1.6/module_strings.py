...
#STRINGS ADDED AFTER THE FREEZE
  ...
  ("faction_title_male_1", " Duke {s0}"),##ZZ
  ("faction_title_male_2", " Marquis {s0}"),##ZZ  
  ("faction_title_male_3", " Count {s0}"),##ZZ
  ("faction_title_male_4", " Viscount {s0}"),##ZZ
  ("faction_title_male_5", " Baron {s0}"),##ZZ
  ("faction_title_male_6", " Lord {s0}"),##ZZ
...
("welcome_word",  "Welcome sir {s1}, This is the BANK OF WORLD.^You can do someting like deposit or loan here.^And we have several banks in other cities.^You can do the same operatin there,too."),  
...
("answer_5", "Your debt had reached your line of credit, ^Please pay the debt, otherwise you can't get any loan."),
...
#xp from old
 ("gained_xp_from_older_soldier", "Gained {reg0} xp from older soldier."),
 #windmelodie begin
   ("lost_8_honor", "you lost 8 honor."),
   ("lost_20_renown", "you lost 20 renown."),   
   ("lost_10_rtr", "you lost 10 right to rule."),
   ("calling_npc", "tavernkeeper of {s1} has send someone to told you that {s0} is arrived"),
	("polearm_broken_message", "{s21} hits with {s22} for {reg20} damage and breaks it."),
	("polearm_broken_chance", "this time you have {reg19}% chance of breaking your weapon"),
	("more_mod_options", "Other Mod Options"),
	("polearm_broken", "polearm broken activate"),
	("polearm_broken_d", "once an agent use polearm, there is a change to break it. The chance is calculated by damage and speed"),
	("polearm_broken_report", "polearm broken chance report activate"),
	("polearm_broken_report_d", "report the chance of polearm break everytime that player make an attack with polearm"),
	("polearm_broken_chance_factor", "change the factor of polearm broken"),
	("polearm_broken_chance_factor_d", "change the factor of polearm broken from 0 to 300, default is 100"),
	("not_enough_gold", "you dont have enough money"),
	("whore_knight", "{reg21} {s1} joined ur party"),
	("whore_nobility", "everyone soon know what you have done"),
	("whore_charisma", "you increased one charisma"),
	("name_fort_text", "Rename your castle"),
    ("patrol_defeated", "your patrol has probably been defeated"),
	("minimap_states", "active minimap states"),
	("minimap_states_d", "active minimap states"),
	("disable_npc_complaints", "disable NPC complaints"),
	("disable_npc_complaints_d", "disable NPC complaints"),
	("auto_civilian_cloth", "auto civilian cloth change"),
	("auto_civilian_cloth_d", "active auto civilian cloth change"),
	("activate_injured", "active injured function"),
	("activate_injured_d", "active injured function"),
	("kill_count", "active kill count"),
	("kill_count_d", "active kill count"),
	("formation_nolimit", "deactive formation limit"),
	("formation_nolimit_d", "deactive formation limit"),
	("reinforcements_windmelodie", "{reg3}{s2},"),
	("not_enough_rtr", "you need more right to rule."),
	("cattle_follow", "allow cattle follow"),
	("cattle_follow_d", "allow cattle follow"),	
	("high", "high"),	
	("middle", "middle"),	
	("low", "low"),	
	("tax_pros_increase", "prosperity of {s1} increases because of the low tax"),	
	("tax_pros_decrease", "prosperity of {s1} decreases because of the high tax"),	
	("tax_relat_increase", "your relationship with {s1} increases because of the low tax"),		
	("tax_relat_decrease", "your relationship with {s1} decreases because of the high tax"),
	("tutorial_mod", "Welcome to the world of 16th"),
	("tutorial_good_trade", "not finished"),
	("diploma_distance", "diploma distance"),
	("diploma_distance_d", "factor from 0 to 100 to adjust the influence of distance to claim a war"),
	("diploma_war_rate", "diploma war rate"),
	("diploma_war_rate_d", "factor from 0 to 100 for how chaos the world is"),
	("set_default", "set default"),
	("set_default_d", "set default"),
	("diploma_event_amout", "diploma event amout"),
	("diploma_event_amout_d", "set the amount of diploma event everyday."),
	("center_castle", "castle"),
	("center_castle_function", "You can build a castle near this village"),
	("center_patrol_center", "patrol center"),
	("center_patrol_center_function", "A patrol center lets you assemble a patrol team"),
	("center_supply_center", "supply center"),
	("center_supply_center_function", "A supply center allows you to get a siege supply every week from seneschal."),
	("center_training_camp", "training camp"),
	("center_training_camp_function", "A training camp managed your seneschal training your troops"),
	("center_market", "market"),
	("center_market_function", "A market where you can buy supplies"),
	("village_notice", "you can build your own village"),
	("village_name","'s village"),
	("castle_name","'s castle"),
	("cant_build_castle_during_mercenary_service","you can not build a castile during mercenary service"),

...
map_icons = [
  ("player",0,"player", avatar_scale, snd_footstep_grass, 0.05, 0.06, 0),
  ("player_horseman",0,"player_horseman", avatar_scale, snd_gallop, 0.05, 0.06, 0),
  ("gray_knight",0,"knight_a", avatar_scale, snd_gallop, 0.05, 0.06, 0),
  ("vaegir_knight",0,"knight_b", avatar_scale, snd_gallop, 0.05, 0.06, 0),
  ("flagbearer_a",0,"flagbearer_a", avatar_scale, snd_gallop, 0.05, 0.06, 0),
  ("flagbearer_b",0,"flagbearer_b", avatar_scale, snd_gallop, 0.05, 0.06, 0),
  ("peasant",0,"peasant_a", avatar_scale,snd_footstep_grass, 0.05, 0.06, 0),
  ("khergit",0,"khergit_horseman", avatar_scale,snd_gallop, 0.05, 0.06, 0),
  ("khergit_horseman_b",0,"khergit_horseman_b", avatar_scale,snd_gallop, 0.05, 0.06, 0),
  ("axeman",0,"bandit_a", avatar_scale,snd_footstep_grass, 0.05, 0.06, 0),
  ("woman",0,"woman_a", avatar_scale,snd_footstep_grass, 0.05, 0.06, 0),
  ("woman_b",0,"woman_b", avatar_scale,snd_footstep_grass, 0.05, 0.06, 0),
  ("town",mcn_no_shadow,"chenchi", 0.18,0),
  ("town_steppe",mcn_no_shadow,"chenchi", 0.12,0),
  ("town_desert",mcn_no_shadow,"map_town_steppe_a", 0.15,0),
  ("village_a",mcn_no_shadow,"map_village_a", 0.15, 0),
  ("village_b",mcn_no_shadow,"icon_india", 0.15, 0),
  ("village_c",mcn_no_shadow,"map_village_c", 0.15, 0),
  ("village_burnt_a",mcn_no_shadow,"map_village_burnt_a", 0.15, 0),
  ("village_deserted_a",mcn_no_shadow,"map_village_deserted_a", 0.15, 0),
  ("village_burnt_b",mcn_no_shadow,"map_village_burnt_b", 0.15, 0),
  ("village_deserted_b",mcn_no_shadow,"map_village_deserted_b", 0.15, 0),
  ("village_burnt_c",mcn_no_shadow,"map_village_burnt_c", 0.15, 0),
  ("village_deserted_c",mcn_no_shadow,"map_village_deserted_c", 0.15, 0),
  ("village_snow_a",mcn_no_shadow,"map_village_snow_a", 0.15, 0),
  ("village_snow_burnt_a",mcn_no_shadow,"map_village_snow_burnt_a", 0.15, 0),
  ("village_snow_deserted_a",mcn_no_shadow,"map_village_snow_deserted_a", 0.12, 0),


  ("camp",mcn_no_shadow,"camp_tent", 0.06, 0),
#  ("ship",mcn_no_shadow,"boat_sail_on", 0.23, snd_footstep_grass, 0.0, 0.05, 0),
("ship",mcn_no_shadow,"merchant_ship", 0.07, snd_footstep_grass, 0.0, 0.05, 0),

  ("ship_on_land",mcn_no_shadow,"boat_sail_off", 0.1, 0),

  ("castle_a",mcn_no_shadow,"map_castle_a", 0.12,0),
  ("castle_b",mcn_no_shadow,"map_castle_b", 0.12,0),
  ("castle_c",mcn_no_shadow,"map_castle_c", 0.12,0),
  ("castle_d",mcn_no_shadow,"map_castle_d", 0.12,0),
  ("castle_e",mcn_no_shadow,"map_castle_a", 0.12,0),  
  ("town_snow",mcn_no_shadow,"map_town_snow_a", 0.12,0),


  ("castle_snow_a",mcn_no_shadow,"map_castle_snow_a", 0.12,0),
  ("castle_snow_b",mcn_no_shadow,"icon_india", 0.15,0),
  ("mule",0,"icon_mule", 0.2,snd_footstep_grass, 0.15, 0.06, 0),
  ("cattle",0,"icon_cow", 0.2,snd_footstep_grass, 0.15, 0.06, 0),
  ("training_ground",mcn_no_shadow,"training", 0.12,0),

  ("bridge_a",mcn_no_shadow,"map_river_bridge_a", 1.27,0),
  ("bridge_b",mcn_no_shadow,"fysg_ta", 0.01,0),
  #yifeng
  ("bridge_snow_a",mcn_no_shadow,"copy_fysg_chengqiang_1", 1.27,0),
...
#yifeng kingdom banner
  ("map_flag_kingdom_1",0,"map_flag_07", banner_scale,0),
("map_flag_kingdom_2",0,"map_flag_09", banner_scale,0),
("map_flag_kingdom_3",0,"map_flag_05", banner_scale,0),
("map_flag_kingdom_4",0,"map_flag_03", banner_scale,0),
("map_flag_kingdom_5",0,"map_flag_02", banner_scale,0),
("map_flag_kingdom_6",0,"map_flag_20", banner_scale,0),
("map_flag_kingdom_7",0,"map_flag_14", banner_scale,0),
("map_flag_kingdom_8",0,"map_flag_04", banner_scale,0),
("map_flag_kingdom_9",0,"map_flag_06", banner_scale,0),
("map_flag_kingdom_10",0,"map_flag_19", banner_scale,0),
("map_flag_kingdom_11",0,"map_flag_13", banner_scale,0),
("map_flag_kingdom_12",0,"map_flag_15", banner_scale,0),
("map_flag_kingdom_13",0,"map_flag_01", banner_scale,0),
("map_flag_kingdom_14",0,"map_flag_08", banner_scale,0),
("map_flag_kingdom_16",0,"map_flag_16", banner_scale,0),
("map_flag_kingdom_17",0,"map_flag_18", banner_scale,0),
("map_flag_kingdom_18",0,"map_flag_10", banner_scale,0),
("map_flag_kingdom_19",0,"map_flag_11", banner_scale,0),
("map_flag_kingdom_20",0,"map_flag_17", banner_scale,0),
("map_flag_kingdom_21",0,"map_flag_12", banner_scale,0),
("map_flag_kingdom_22",0,"map_flag_21", banner_scale,0),

("map_flag_kingdom_23",0,"map_flag_d04", banner_scale,0),
("map_flag_kingdom_24",0,"map_flag_d05", banner_scale,0),
("map_flag_kingdom_25",0,"map_flag_d01", banner_scale,0),
("map_flag_kingdom_26",0,"map_flag_d03", banner_scale,0),
("map_flag_kingdom_27",0,"map_flag_d02", banner_scale,0),
("map_flag_kingdom_28",0,"map_flag_d06", banner_scale,0),
("map_flag_kingdom_29",0,"map_flag_56", banner_scale,0),

#yifeng 1.5
("map_flag_kingdom_30",0,"map_flag_d07", banner_scale,0),
("map_flag_kingdom_31",0,"map_flag_d08", banner_scale,0),
("map_flag_kingdom_32",0,"map_flag_e20", banner_scale,0),
("map_flag_kingdom_33",0,"map_flag_f15", banner_scale,0),

  ("banner_136",0,"map_flag_15", banner_scale,0),
  ("banner_137",0,"map_flag_13", banner_scale,0),

  ("bandit_lair",mcn_no_shadow,"map_bandit_lair", 0.15, 0),
## ZZ new map icon
  ("town_volencia",mcn_no_shadow,"map_town_volencia", 0.18,0), 
#  ("town_china",mcn_no_shadow,"chenchi", 0.4,0), #china
  ("aztec",mcn_no_shadow,"map_city_aztec", 0.13,0),

  ("castle_x_1",mcn_no_shadow,"map_castle_x_1", 0.12,0),
  ("castle_x_2",mcn_no_shadow,"map_castle_x_2", 0.12,0),
  ("castle_x_3",mcn_no_shadow,"map_castle_x_3", 0.12,0),
  ("castle_x_4",mcn_no_shadow,"map_castle_x_4", 0.12,0),
  ("castle_x_5",mcn_no_shadow,"map_castle_x_5", 0.12,0),
  ("castle_x_6",mcn_no_shadow,"map_castle_x_6", 0.12,0),
  ("castle_x_7",mcn_no_shadow,"map_castle_x_7", 0.12,0),
  ("castle_x_8",mcn_no_shadow,"map_castle_x_8", 0.12,0),
  ("castle_x_9",mcn_no_shadow,"map_castle_x_9", 0.12,0),
  ("castle_x_10",mcn_no_shadow,"map_castle_x_10", 0.12,0),
  ("castle_x_11",mcn_no_shadow,"xiongben", 0.15,0),
  ("castle_x_12",mcn_no_shadow,"map_castle_x_12", 0.12,0),
  ("castle_x_13",mcn_no_shadow,"map_castle_x_13", 0.12,0),
  ("castle_x_14",mcn_no_shadow,"map_castle_x_14", 0.12,0),
  ("castle_x_15",mcn_no_shadow,"map_castle_x_15", 0.12,0),
  ("castle_x_16",mcn_no_shadow,"map_castle_x_16", 0.12,0),
  ("castle_x_17",mcn_no_shadow,"map_castle_x_17", 0.12,0),
  ("castle_x_18",mcn_no_shadow,"map_castle_x_18", 0.12,0),
  ("castle_x_19",mcn_no_shadow,"map_castle_x_19", 0.12,0),
  ("castle_x_20",mcn_no_shadow,"map_castle_x_20", 0.12,0),
  ("castle_x_21",mcn_no_shadow,"map_castle_x_21", 0.12,0),
  ("castle_x_22",mcn_no_shadow,"map_castle_x_22", 0.12,0),
  ("castle_x_23",mcn_no_shadow,"map_castle_x_23", 0.12,0),
  ("castle_y_1",mcn_no_shadow,"map_castle_y_1", 0.12,0),
  ("castle_y_2",mcn_no_shadow,"map_castle_y_2", 0.12,0),
  ("castle_y_3",mcn_no_shadow,"map_castle_y_3", 0.12,0),
  ("castle_y_4",mcn_no_shadow,"map_castle_y_4", 0.12,0),
  ("castle_y_5",mcn_no_shadow,"map_castle_y_5", 0.12,0),
  ("castle_desert_1",mcn_no_shadow,"map_castle_desert_1", 0.12,0),
  ("castle_desert_2",mcn_no_shadow,"map_castle_desert_2", 0.12,0),
  ("castle_desert_3",mcn_no_shadow,"map_castle_desert_3", 0.12,0),
  ("castle_desert_4",mcn_no_shadow,"map_castle_desert_4", 0.12,0),
  ("castle_desert_5",mcn_no_shadow,"map_castle_desert_5", 0.12,0),
  ("castle_desert_6",mcn_no_shadow,"map_castle_desert_6", 0.12,0),
  ("castle_desert_7",mcn_no_shadow,"map_castle_desert_7", 0.12,0),
  ("castle_desert_8",mcn_no_shadow,"map_castle_desert_8", 0.12,0),
  ("castle_desert_9",mcn_no_shadow,"map_castle_desert_9", 0.12,0),
  ("castle_desert_10",mcn_no_shadow,"map_castle_desert_10", 0.12,0),
  ("castle_desert_11",mcn_no_shadow,"map_castle_desert_11", 0.12,0), 
  ("castle_wood_1",mcn_no_shadow,"map_castle_wood_1", 0.12,0),
  ("castle_wood_2",mcn_no_shadow,"map_castle_wood_2", 0.12,0),
  ("castle_wood_3",mcn_no_shadow,"map_castle_wood_3", 0.12,0),
#great wall
  ("castle_wood_4",mcn_no_shadow,"copy_sino_battlement_a", 0.12,0),
  ("castle_wood_5",mcn_no_shadow,"xiongben", 0.12,0),
 # ("castle_china",mcn_no_shadow,"chenchi", 0.35,0),
  
  ("river_bridge",mcn_no_shadow, "map_river_bridge_c", 0.4,0), 
  
# Siege camp icon ## ZZ
  ("castle_besieged", mcn_no_shadow, "castle_a_spike_siege_combined", 0.24, 0),
  ("castle_no_besieged", mcn_no_shadow, "castle_no_extra_icon", 0, 0),  
# Siege camp icon ## ZZ  
## ZZ new map icon  

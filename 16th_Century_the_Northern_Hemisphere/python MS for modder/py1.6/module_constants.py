...
##############################################################
#-## Outposts begin by windmelodie
slot_outpost_level  = 19
slot_outpost_patrol = 500
slot_outpost_act = 501
slot_outpost_notice = 502
slot_castle_supply = 503
slot_castle_training_rate = 504

#new improvements by windmelodie
slot_center_has_castle          = 550 #village_special #also used to check activating state


slot_center_has_patrol_center          = 551 #village

slot_center_has_supply_center			= 560 #castle
slot_center_has_training_camp			= 561 #castle
slot_center_has_market					= 562 #castle



village_new_improvements_begin 			= slot_center_has_castle
village_new_improvements_end        	= slot_center_has_patrol_center+1

castle_new_improvements_begin 			= slot_center_has_supply_center
castle_new_improvements_end        	= slot_center_has_market+1

town_new_improvements_begin 			= 0
town_new_improvements_end        	= 0
...
### recruiter kit end
##Sea battle
slot_agent_total_ammo = 346
slot_troop_specified_weapons = 347
slot_troop_weapon_1 = 348
slot_troop_weapon_primary = 349
slot_agent_is_dead_for_waterbattle = 350

########################################################
##  ITEM SLOTS             #############################
########################################################
## ZZ new slot begin
slot_party_patrol                   = 400 ## ZZ partol
slot_town_has_bank                  = 303 ## ZZ bank
slot_troop_debt                     = 301 ## ZZ bank
slot_troop_deposit                  = 302 ## ZZ bank
slot_troop_line_of_credit           = 305 ## ZZ bank
slot_troop_line_of_credit_addition  = 306 ## ZZ bank
slot_troop_debt_date                = 307 ## ZZ bank
slot_bank_manager                   = 304 ## ZZ bank
slot_item_difficulty                = 101 ## ZZ custom troop item_detial
slot_item_weight                    = 102 ## ZZ custom troop item_detial
slot_item_price                     = 103 ## ZZ custom troop item_detial
slot_custom_troop_wage              = 313 ## custom troop
slot_custom_troop_weight            = 314 ## custom troop
slot_custom_troop_ap                = 315 ## custom troop
slot_custom_troop_sp                = 316 ## custom troop
slot_custom_troop_wp                = 317 ## custom troop
slot_agent_horse                    = 30  ## call horse
slot_troop_title                    = 310 ## ZZ title
slot_center_troop_1                 = 310

#slot_item_special_item           = 78#yifeng
slot_item_civilian_item           = 79

slot_item_two_hand_one_hand         = 104
slot_item_needs_two_hands           = 105
slot_item_couchable                 = 106
slot_item_pike                      = 107
slot_item_cant_on_horseback         = 108
slot_item_length                    = 109
...
lco_storage = "trp_companions_overview" ## COMPANIONS OVERSEER by LAV
lco_garbage = "trp_companions_discard"  ## COMPANIONS OVERSEER by LAV
lco_run_presentation = 1                ## COMPANIONS OVERSEER by LAV
lco_view_character = 2                  ## COMPANIONS OVERSEER by LAV

custom_troop_begin = "trp_kingdom_recruit"
custom_troop_end = "trp_bank_manager_1"
#loop_num_1="$g_presentation_obj_1"
#loop_num_2="$g_presentation_obj_2"
#loop_num_3="$g_presentation_obj_3"
#loop_num_4="$g_presentation_obj_4"
...
smaller_size  = 600
tinny_size    = 450
troop_tree_size_x  = 375#375
troop_tree_size_y  = 500#500
troop_tree_space_x = 150#170
troop_tree_space_y = 100#140#170
troop_tree_left    = 60
# Presentations Constants
## ZZ new slot end
...
slot_item_new_trade_good_town = 100 #add by windmelodie
...
##HolyAce
slot_faction_reinforcements_a        = 76
slot_faction_reinforcements_b        = 77
slot_faction_reinforcements_c        = 78
slot_faction_reinforcements_d        = 79
...
slot_town_seneschal				= 400  #add by windmelodie
slot_center_tax_rate			= 401  #add by windmelodie 
...
slot_troop_kill_cnt = 200 # Must use a number large than last troop slot 141. I use 200 here.
slot_troop_new_good_town = 201 #add by windmelodie for trade
...
##slto_merchant           = 1
slto_inactive           = 0 #(change from 0 yifeng)for companions at the beginning of the game
...
villages_end   = "p_gate1"

##yifeng
yifeng_party_begin		= "p_training_ground"
yifeng_party_end		= "p_salt_mine"
...
trade_new_goods_begin = "itm_good_whisky"
trade_new_goods_end = "itm_quest_wine"
trade_goods_begin = "itm_spice"
trade_goods_end = trade_new_goods_begin
food_begin = "itm_smoked_fish"
food_end = trade_new_goods_begin
...
########################################################
##  Mod SLOTS  "fac_mod_variables" #####################
########################################################


slot_Mod_NPC_NPCID_ask					= 1
slot_Mod_NPC_NPCState					= 2
slot_Mod_NPC_Calling_NPC				= 3
slot_Mod_NPC_Call_NPC_town				= 4
slot_Mod_fort_patrol_reinforce			= 5
slot_Mod_polearm_broken					= 6
slot_Mod_polearm_broken_report			= 7
slot_Mod_polearm_broken_chance_factor	= 8
slot_Mod_whore_hours					= 9
slot_Mod_whore_charisma					= 10
slot_Mod_auto_civilian_cloth			= 11
slot_Mod_activate_injured				= 12
slot_Mod_cattle_follow					= 13
slot_Mod_good_trade						= 14
slot_Mod_fst_good_trade					= 15
slot_Mod_army_wounded					= 16
slot_Mod_diploma_distance				= 17
slot_Mod_diploma_war_rate				= 18
slot_Mod_diploma_event_amout			= 19
slot_Mod_townlord_before_mercenary_s	= 20
...
chest_begin = "trp_town_18_chest"
chest_end = "trp_town_1_seneschal"#yifeng 1.5

trade_new_goods_farmer_begin = "trp_farmer_whisky"
trade_new_goods_farmer_end = "trp_new_goods_merchant_1"
trade_new_goods_merchant_begin = "trp_new_goods_merchant_1"
trade_new_goods_merchant_end = "trp_troop_end"
castel_seneschal_begin = "trp_castle_1_seneschal"
castel_seneschal_end = "trp_find_item_cheat"#yifeng 1.5

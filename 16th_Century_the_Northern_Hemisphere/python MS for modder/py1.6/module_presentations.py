...
##        (overlay_set_text, "$g_multiplayer_team_2_score_display_overlay", "str_s0_dd_reg0"),
  ...
  ("name_castle",0,mesh_load_window,[
      (ti_on_presentation_load,
       [(set_fixed_point_multiplier, 1000),
        (str_store_string, s1, "str_name_fort_text"),
        (create_text_overlay, reg1, s1, tf_center_justify),
        (position_set_x, pos1, 500),
        (position_set_y, pos1, 500),
        (overlay_set_position, reg1, pos1),
...
## Windmelodie Kingdom_color begin


## add RGB box to change color of player_supporters_faction	   
 ...
 #RGB Box
        (create_number_box_overlay, reg2,0,256),#Red Box
        (position_set_x, pos1, 100),
        (position_set_y, pos1, 400),
        (overlay_set_position, reg2, pos1),
        (create_number_box_overlay, reg3,0,256),#Green Box
        (position_set_x, pos1, 100),
        (position_set_y, pos1, 375),
        (overlay_set_position, reg3, pos1),
        (create_number_box_overlay, reg4,0,256),#Blue Box
        (position_set_x, pos1, 100),
        (position_set_y, pos1, 350),
        (overlay_set_position, reg4, pos1),
        (create_mesh_overlay, reg5, "mesh_white_plane"),#Color Box
        (position_set_x, pos1, 200),
        (position_set_y, pos1, 350),
        ...
        (faction_get_color, ":color_Mix", "fac_player_supporters_faction"),
        (overlay_set_color, reg5, ":color_Mix"),
        
        (store_mod, ":color_Blue", ":color_Mix", 0x100),
        (val_div, ":color_Mix", 0x100),
        (store_mod, ":color_Green", ":color_Mix", 0x100),
        (val_div, ":color_Mix", 0x100),
        (store_mod, ":color_Red", ":color_Mix", 0x100),
        
        (overlay_set_val, reg2, ":color_Red"),
        (overlay_set_val, reg3, ":color_Green"),
        (overlay_set_val, reg4, ":color_Blue"),
## Windmelodie Kingdom_color end

        
		## ZZ	 custom_kingdom_troop 
	...
	(try_begin),
## Windmelodie Kingdom_color begin
          (this_or_next|eq,":object", reg2),
          (this_or_next|eq,":object", reg3),
          (eq,":object", reg4),
		  (faction_get_color, ":color_Mix", "fac_player_supporters_faction"),
		  (store_mod, ":color_Blue", ":color_Mix", 0x100),
		  (val_div, ":color_Mix", 0x100),
          ...
          (try_begin),
            (eq,":object", reg2),
            (assign, ":color_Red", ":value"),
          (else_try),
            (eq,":object", reg3),
            (assign, ":color_Green", ":value"),
          (else_try),
            (eq,":object", reg4),
            (assign, ":color_Blue", ":value"),      
          (try_end),
          (assign, ":color_Mix", 0xFF),
          (val_mul, ":color_Mix", 0x100),
          (val_add, ":color_Mix", ":color_Red"),
          (val_mul, ":color_Mix", 0x100),
          (val_add, ":color_Mix", ":color_Green"),
          (val_mul, ":color_Mix", 0x100),
          (val_add, ":color_Mix", ":color_Blue"),
          (overlay_set_color, reg5, ":color_Mix"),
## Windmelodie Kingdom_color begin
          (faction_set_color, "fac_player_supporters_faction", ":color_Mix"),
## Windmelodie Kingdom_color end
       (else_try),
## Windmelodie Kingdom_color end
          (eq, ":object", "$g_presentation_obj_name_kingdom_1"),
...
## Windmelodie Heroes_banner changed begin

# set selected banner as fac banner by windmelodie begin
          (store_add,":selected_banner_fac",":selected_banner_spr", banner_meshes_begin),
          (val_sub, ":selected_banner_fac", banner_scene_props_begin),
          (faction_set_slot, "fac_player_supporters_faction", slot_faction_banner,":selected_banner_fac" ),
          (faction_set_slot, "fac_player_faction", slot_faction_banner,":selected_banner_fac" ),
# set selected banner as fac banner by windmelodie end
...
#              (party_set_banner_icon, ":cur_center", banner_map_icons_end_minus_one), 
          ...
          (try_end),
        (try_end),
## Windmelodie Heroes_banner changed end
        ]),
      (ti_on_presentation_run,
       [(try_begin),
          (this_or_next|key_clicked, key_space),
      ...
      (ti_on_presentation_run,
       [(store_trigger_param_1, ":cur_time"),
        ...
        (try_begin),
          ...
          (try_end),
          (presentation_set_duration, 0),
          (start_presentation, "prsnt_mini_map"), ## ZZ minimap  		  
        (try_end),
        ]),
      ]),
...
("mini_map", prsntf_read_only, 0, [
    (ti_on_presentation_load,
     [
      ...
      (try_begin),
        (gt, ":map_ratio", 100),
        (assign, "$g_battle_map_width", 150),#yifeng
        (store_div, "$g_battle_map_scale", ":map_width", "$g_battle_map_width"),
        (store_div, "$g_battle_map_height", ":map_height", "$g_battle_map_scale"),
      (else_try),
        (assign, "$g_battle_map_height", 150),#yifeng
        (store_div, "$g_battle_map_scale", ":map_height", "$g_battle_map_height"),
        (store_div, "$g_battle_map_width", ":map_width", "$g_battle_map_scale"),
      (try_end),
	  ...
	  (try_begin),
	  (eq, "$minimap_state",2),	  
      (create_text_overlay, "$g_presentation_obj_24", s8, tf_left_align),
      (position_set_x, pos1, 750),
      (position_set_y, pos1, 300),
      (overlay_set_position, "$g_presentation_obj_24", pos1),
      (overlay_set_color, "$g_presentation_obj_24", 0xffffff),

      (create_text_overlay, "$g_presentation_obj_25", s9, tf_left_align),
      (position_set_x, pos1, 830),
      (position_set_y, pos1, 300),
      (overlay_set_position, "$g_presentation_obj_25", pos1),
      (overlay_set_color, "$g_presentation_obj_25", 0x0000dd),	  

      (create_text_overlay, "$g_presentation_obj_26", s10, tf_left_align),
      (position_set_x, pos1, 910),
      (position_set_y, pos1, 300),
      (overlay_set_position, "$g_presentation_obj_26", pos1),
      (overlay_set_color, "$g_presentation_obj_26", 0xff0000),	
	  
      (create_text_overlay, "$g_presentation_obj_23", s7, tf_left_align),
      (position_set_x, pos1, 670),
      (position_set_y, pos1, 300),
      (overlay_set_position, "$g_presentation_obj_23", pos1),
      (overlay_set_color, "$g_presentation_obj_23", 0x00000),	 	  
      ...
      (overlay_set_position, "$g_battle_report_plane", pos1),
      (overlay_set_alpha, "$g_battle_report_plane", 0x22),
      (try_end), 
  ...
  ("bank", prsntf_manual_end_only, mesh_load_window,[
    (ti_on_presentation_load,
     [
		...
		(str_store_string,s1,"@BANK OF ^WORLD"),	
        ...
        (create_mesh_overlay_with_tableau_material, "$g_presentation_obj_2", -1, "tableau_troop_note_mesh", ":troop_manager"),
		(position_set_x, pos1, 50),
		(position_set_y, pos1, 80),
		(overlay_set_position, "$g_presentation_obj_2", pos1),
        (position_set_x, pos1, 700),
		...
		(else_try),
			(eq,"$g_bank_talk",15),
			(create_text_overlay, "$g_presentation_obj_25","str_answer_5",tf_left_align),
			(position_set_x, pos1, 300),
			(position_set_y, pos1, 150),
			(overlay_set_position, "$g_presentation_obj_25", pos1),
			(position_set_x, pos1, 1000),
       ...
       (store_trigger_param_2, ":value"),	
		...
		(else_try),
			...
			(else_try),
				...
				(else_try),
					(eq,"$g_pay_get",1),
					(store_mul,":loannum",1000,"$player_honor"), ## Once loan line
					(troop_get_slot,":debt","trp_player",slot_troop_debt),
					(troop_get_slot,":loanline","trp_player",slot_troop_line_of_credit),## total loan line
					(try_begin),
						(ge,":loanline",":debt"),					
						(try_begin),
					    ...
					    (try_end),
					(else_try),
						(display_message,"@Your can't loan any money unless you pay the debt"),
						(assign,"$g_bank_talk",15),							
						(start_presentation, "prsnt_bank"),						
					(try_end),						
				(try_end),
			(try_end),
     ...
     (ti_on_presentation_event_state_change,
      [
		...
		(else_try),	
            ...
            (store_sub,":offset","$temp_troop",custom_troop_begin),
		...
		(else_try),	
	      ...
	      (call_script,"script_get_custom_troop_info","trp_kingdom_temp"),
			...
			(store_div,":attribute_point",":skill_point",2),
		...
		(else_try),	
			...
			(assign, "$cheat_find_item_range_begin", "itm_sumpter_horse"),	#Yifeng item beginning   change from itm_tutorial_staff
...
#yifeng changfu
			(try_begin),
				(ge, ":item_no", "itm_tutorial_staff"),			
				(le, ":item_no", "itm_items_end"),
    ...
    (ti_on_presentation_event_state_change,
      [
        ...
        (else_try),
			...
			(call_script,"script_get_custom_troop_info","$temp_troop"),
			(call_script,"script_store_custom_troop_info_to_slot","trp_array_b"),		
            (assign, "$cheat_find_item_range_begin", 0),#Yifeng about item add1.55
			(start_presentation, "prsnt_custom_troop"),			
        (try_end),		
...
#map_min_x   = -440.563873
#map_max_x   = 262.903717
#map_min_y   = -89.318077
#map_max_y   = 90.301582
        (assign, ":min_map_x", -237*1000),
        (assign, ":max_map_x", 263*1000),
        (assign, ":min_map_y", -90*1000),
        (assign, ":max_map_y", 91*1000),
          ...
          (try_for_range, ":unused_cols", 0, ":total_cols"),
            ...
            (try_begin),
              (this_or_next|eq,":current_terrain",rt_water),
            	(eq,":current_terrain", rt_deep_ocean),
            	(assign, ":dest_color", 0xFFFFFF), # default
#yifeng add
 ...
 ## draw borderlines begin [optional]DELETE
 ...
 # offset
        ...
        (try_for_range, ":cur_kingdom", kingdoms_begin, kingdoms_end),
		  ...
		  (store_sub,":num",":cur_kingdom","fac_kingdom_1"),
		  (try_begin),
			(eq,":num",-1),
			(assign,":num",14),
		  (try_end),
		  (store_div,":line",":num",4),
		  (store_mod,":col",":num",4),
		  (store_mul,":offset_x",200,":col"),
		  (store_mul,":offset_y",35,":line"),
		  (store_add,":pos_x", 50,":offset_x"),
          (store_sub,":pos_y", 330,":offset_y"),		  
          # color block
          (create_mesh_overlay, reg0, "mesh_white_plane"),
...
## yifeng rename party end	  

##yifeng remove the code
	  
## windmelodie mod options begin
 ("more_mod_options", 0, mesh_load_window, [
    (ti_on_presentation_load,
      [
        (presentation_set_duration, 999999),
        (set_fixed_point_multiplier, 1000),
        ...
        #Open polearm broken
        (create_text_overlay, reg0, "str_polearm_broken", tf_vertical_align_center),
		...
		#open polearm broken report	
        (create_text_overlay, reg0, "str_polearm_broken_report", tf_vertical_align_center),
        (position_set_y, pos1, ":headings_y"),
        (overlay_set_position, reg0, pos1),
		(val_sub, ":headings_y", ":cur_y_shift"),
		
		(store_add, ":line_1_y", ":headings_y", ":line_y_shift"), #LINE 1 Here
		
		#open minimap
		(create_text_overlay, reg0, "str_minimap_states", tf_vertical_align_center),
        (position_set_y, pos1, ":headings_y"),
        (overlay_set_position, reg0, pos1),
		(val_sub, ":headings_y", ":cur_y_shift"),
		
		#disable npc complaints
		(create_text_overlay, reg0, "str_disable_npc_complaints", tf_vertical_align_center),
        (position_set_y, pos1, ":headings_y"),
        (overlay_set_position, reg0, pos1),
		(val_sub, ":headings_y", ":cur_y_shift"),	
				
		#auto_civilian_cloth
		(create_text_overlay, reg0, "str_auto_civilian_cloth", tf_vertical_align_center),
        (position_set_y, pos1, ":headings_y"),
        (overlay_set_position, reg0, pos1),
		(val_sub, ":headings_y", ":cur_y_shift"),	
				
		#activate_injured
		(create_text_overlay, reg0, "str_activate_injured", tf_vertical_align_center),
        (position_set_y, pos1, ":headings_y"),
        (overlay_set_position, reg0, pos1),
		(val_sub, ":headings_y", ":cur_y_shift"),	
		...
		#cattle_follow
		(create_text_overlay, reg0, "str_cattle_follow", tf_vertical_align_center),
        (position_set_y, pos1, ":headings_y"),
        (overlay_set_position, reg0, pos1),
		(val_sub, ":headings_y", ":cur_y_shift"),	
		...
		(create_check_box_overlay, "$g_presentation_obj_name_kingdom_1", "mesh_checkbox_off", "mesh_checkbox_on"), #polearm_broken
        (position_set_y, pos1, ":inputs_y"),
        (overlay_set_position, "$g_presentation_obj_name_kingdom_1", pos1),
		(val_sub, ":inputs_y", ":cur_y_shift"),

        (create_check_box_overlay, reg0, "mesh_checkbox_off", "mesh_checkbox_on"), #polearm_broken_report
        (position_set_y, pos1, ":inputs_y"),
        (overlay_set_position, reg0, pos1),  
        (val_sub, ":inputs_y", ":cur_y_shift"),		

        (create_check_box_overlay, reg0, "mesh_checkbox_off", "mesh_checkbox_on"), #minimap_states|
        (position_set_y, pos1, ":inputs_y"),
        (overlay_set_position, reg0, pos1),  
        (val_sub, ":inputs_y", ":cur_y_shift"),		
		
		(create_check_box_overlay, reg0, "mesh_checkbox_off", "mesh_checkbox_on"), #disable_npc_complaints
        (position_set_y, pos1, ":inputs_y"),
        (overlay_set_position, reg0, pos1),  
        (val_sub, ":inputs_y", ":cur_y_shift"),		
		
			
		(create_check_box_overlay, reg0, "mesh_checkbox_off", "mesh_checkbox_on"), #auto_civilian_cloth|
        (position_set_y, pos1, ":inputs_y"),
        (overlay_set_position, reg0, pos1),  
        (val_sub, ":inputs_y", ":cur_y_shift"),		
				
		(create_check_box_overlay, reg0, "mesh_checkbox_off", "mesh_checkbox_on"), #activate_injured
        (position_set_y, pos1, ":inputs_y"),
        (overlay_set_position, reg0, pos1),  
        (val_sub, ":inputs_y", ":cur_y_shift"),		
				
		(create_check_box_overlay, reg0, "mesh_checkbox_off", "mesh_checkbox_on"), #cattle_follow
        (position_set_y, pos1, ":inputs_y"),
        (overlay_set_position, reg0, pos1),  
        (val_sub, ":inputs_y", ":cur_y_shift"),		
		...
		(faction_get_slot,":polearm_broken","fac_mod_variables",slot_Mod_polearm_broken),
        (overlay_set_val, ":overlay", ":polearm_broken"),
		(val_add, ":overlay", 1),
		
		(faction_get_slot,":polearm_broken_report","fac_mod_variables",slot_Mod_polearm_broken_report),
		(overlay_set_val, ":overlay", ":polearm_broken_report"),
		(val_add, ":overlay", 1),
		
		(assign, ":minimap","$minimap_state"),
		(val_sub, ":minimap", 1),
		(overlay_set_val, ":overlay", ":minimap"),
		(val_add, ":overlay", 1),
				
		(overlay_set_val, ":overlay", "$disable_npc_complaints"),
		(val_add, ":overlay", 1),		
				
		(faction_get_slot,":auto_civilian_cloth","fac_mod_variables",slot_Mod_auto_civilian_cloth),
        (overlay_set_val, ":overlay", ":auto_civilian_cloth"),
		(val_add, ":overlay", 1),		

		(faction_get_slot,":activate_injured","fac_mod_variables",slot_Mod_activate_injured),
        (overlay_set_val, ":overlay", ":activate_injured"),
		(val_add, ":overlay", 1),

		(faction_get_slot,":cattle_follow","fac_mod_variables",slot_Mod_cattle_follow),
        (overlay_set_val, ":overlay", ":cattle_follow"),
		(val_add, ":overlay", 1),

		## Mouse-over Tips	
		(create_text_overlay, reg0, "str_more_mod_options", tf_center_justify|tf_with_outline),
		(overlay_set_color, reg0, 0xFFFFFFFF),
		(position_set_x, pos1, 800),
        (position_set_y, pos1, 600),
        (overlay_set_position, reg0, pos1),
      ...
      [
		...
		(try_begin),
			#Button Done
			(assign,":overlay","$g_presentation_obj_name_kingdom_2"),
			(eq, ":object",":overlay"), 
			(presentation_set_duration, 0),
		...
		(else_try),
			...
			(val_add, ":overlay", 1),
			(eq, ":object", ":overlay"), 
			(call_script, "script_mod_options_default"),
		...
		(else_try),
			#polearm_broken
	  		(assign,":overlay","$g_presentation_obj_name_kingdom_1"),
			(eq, ":object", ":overlay"), 
			(faction_set_slot,"fac_mod_variables",slot_Mod_polearm_broken,":value"),
		  
		(else_try),
			#polearm_broken_report	 
			(val_add, ":overlay", 1),
			(eq, ":object", ":overlay"),  
			(faction_set_slot,"fac_mod_variables",slot_Mod_polearm_broken_report,":value"),     
		...
		(else_try),
			...
			(val_add, ":overlay", 1),
			(eq, ":object", ":overlay"), 
			(faction_set_slot,"fac_mod_variables",slot_Mod_auto_civilian_cloth,":value"),  
			
		(else_try),
			#activate_injured
			(val_add, ":overlay", 1),
			(eq, ":object", ":overlay"), 
			(faction_set_slot,"fac_mod_variables",slot_Mod_activate_injured,":value"),  
			
		(else_try),
			#cattle_follow
			(val_add, ":overlay", 1),
			(eq, ":object", ":overlay"), 
			(faction_set_slot,"fac_mod_variables",slot_Mod_cattle_follow,":value"),  
	  ...
	  [
		...
		(else_try),
			(eq, ":enter_leave", 0),
			(assign, ":overlay", "$g_presentation_obj_name_kingdom_1"), #Input
			...
			(else_try),
				...
				(eq, ":object", ":overlay"), 	  
				(overlay_set_text, "$g_presentation_obj_banner_selection_1", "str_polearm_broken_d"),    
			...
			(else_try),
				...
				(this_or_next|eq, ":object", ":overlay_2"),
				(eq, ":object", ":overlay"),
				(overlay_set_text, "$g_presentation_obj_banner_selection_1", "str_polearm_broken_report_d"),       
			...
			(else_try),
				...
				(this_or_next|eq, ":object", ":overlay_2"),
				(eq, ":object", ":overlay"),
				(overlay_set_text, "$g_presentation_obj_banner_selection_1", "str_minimap_states_d"),       
			...
			(else_try),
				...
				(this_or_next|eq, ":object", ":overlay_2"),
				(eq, ":object", ":overlay"),
				(overlay_set_text, "$g_presentation_obj_banner_selection_1", "str_disable_npc_complaints_d"),       
			...
			(else_try),
				...
				(this_or_next|eq, ":object", ":overlay_2"),
				(eq, ":object", ":overlay"),
				(overlay_set_text, "$g_presentation_obj_banner_selection_1", "str_auto_civilian_cloth_d"),       
			...
			(else_try),
				...
				(this_or_next|eq, ":object", ":overlay_2"),
				(eq, ":object", ":overlay"),
				(overlay_set_text, "$g_presentation_obj_banner_selection_1", "str_activate_injured_d"),       
			...
			(else_try),
				...
				(this_or_next|eq, ":object", ":overlay_2"),
				(eq, ":object", ":overlay"),
				(overlay_set_text, "$g_presentation_obj_banner_selection_1", "str_cattle_follow_d"), 
...
## windmelodie mod options begin
 ("cheat_mod_options", 0, mesh_load_window, [
    (ti_on_presentation_load,
      [
        (presentation_set_duration, 999999),
        (set_fixed_point_multiplier, 1000),
		...
		#reset some settings
		(create_text_overlay, reg0, "str_set_default", tf_vertical_align_center),
        (position_set_y, pos1, ":headings_y"),
        (overlay_set_position, reg0, pos1),
		(val_sub, ":headings_y", ":cur_y_shift"),
		...
		#adjust polearm broken chance factor
		(create_text_overlay, reg0, "str_polearm_broken_chance_factor", tf_vertical_align_center),
        (position_set_y, pos1, ":headings_y"),
        (overlay_set_position, reg0, pos1),
		(val_sub, ":headings_y", ":cur_y_shift"),
		...
		#adjust diploma distance
		(create_text_overlay, reg0, "str_diploma_distance", tf_vertical_align_center),
        (position_set_y, pos1, ":headings_y"),
        (overlay_set_position, reg0, pos1),
		(val_sub, ":headings_y", ":cur_y_shift"),
		
		#adjust diploma war rate	
		(create_text_overlay, reg0, "str_diploma_war_rate", tf_vertical_align_center),
        (position_set_y, pos1, ":headings_y"),
        (overlay_set_position, reg0, pos1),
		(val_sub, ":headings_y", ":cur_y_shift"),
		
		#adjust diploma judge amount
		(create_text_overlay, reg0, "str_diploma_event_amout", tf_vertical_align_center),
        (position_set_y, pos1, ":headings_y"),
        (overlay_set_position, reg0, pos1),
		(val_sub, ":headings_y", ":cur_y_shift"),
		...
		(val_sub, ":inputs_y", 9),
        (create_game_button_overlay, "$g_presentation_obj_name_kingdom_1", "@Reset", tf_center_justify),
        (position_set_y, pos1, ":inputs_y"),
		(overlay_set_position, "$g_presentation_obj_name_kingdom_1", pos1),  #Reset settings
		(val_add, ":inputs_y", 9),
        (val_sub, ":inputs_y", ":cur_y_shift"),	
		
		
		(val_sub, ":inputs_y", 9),	
		(create_number_box_overlay, reg0, 0, 301),
        (position_set_y, pos1, ":inputs_y"),
        (overlay_set_position, reg0, pos1),#polearm_broken_chance_factor
		(val_add, ":inputs_y", 9),
        (val_sub, ":inputs_y", ":cur_y_shift"),			
        ...
        (position_set_y, pos1, ":inputs_y"),
        (overlay_set_position, reg0, pos1),#diploma_distance
		(val_add, ":inputs_y", 9),
        (val_sub, ":inputs_y", ":cur_y_shift"),		
		...
		(create_number_box_overlay, reg0, 0, 101),
        (position_set_y, pos1, ":inputs_y"),
        (overlay_set_position, reg0, pos1),#diploma_war_rate
		(val_add, ":inputs_y", 9),
        (val_sub, ":inputs_y", ":cur_y_shift"),		
		
		(val_sub, ":inputs_y", 9),	
		(create_number_box_overlay, reg0, 10, 101),
        (position_set_y, pos1, ":inputs_y"),
        (overlay_set_position, reg0, pos1),#diploma_judge_amount
		(val_add, ":inputs_y", 9),
        (val_sub, ":inputs_y", ":cur_y_shift"),		
		...
		(faction_get_slot,":polearm_broken_chance_factor","fac_mod_variables",slot_Mod_polearm_broken_chance_factor),
		(overlay_set_val, ":overlay", ":polearm_broken_chance_factor"),
		(val_add, ":overlay", 1),
				
		(faction_get_slot,":diploma_distance","fac_mod_variables",slot_Mod_diploma_distance),
		(overlay_set_val, ":overlay", ":diploma_distance"),
		(val_add, ":overlay", 1),
		
		(faction_get_slot,":diploma_war_rate","fac_mod_variables",slot_Mod_diploma_war_rate),
		(overlay_set_val, ":overlay", ":diploma_war_rate"),
		(val_add, ":overlay", 1),
		
		(faction_get_slot,":diploma_event_amout","fac_mod_variables",slot_Mod_diploma_event_amout),
		(overlay_set_val, ":overlay", ":diploma_event_amout"),
		(val_add, ":overlay", 1),
      ...
      [
		...
		(else_try),
			...
			(val_add, ":overlay", 1),
			(eq, ":object", ":overlay"), 
			(call_script, "script_cheat_mod_options_default"),
		...
		(else_try),
			#polearm_broken_chance_factor
			(val_add, ":overlay", 1),
			(eq, ":object", ":overlay"), 
			(faction_set_slot,"fac_mod_variables",slot_Mod_polearm_broken_chance_factor,":value"),  
			
		(else_try),
			#diploma_distance 
			(val_add, ":overlay", 1),
			(eq, ":object", ":overlay"),  
			(faction_set_slot,"fac_mod_variables",slot_Mod_diploma_distance,":value"),     
		  
		(else_try),
			#diploma_war_rate
			(val_add, ":overlay", 1),
			(eq, ":object", ":overlay"), 
			(faction_set_slot,"fac_mod_variables",slot_Mod_diploma_war_rate,":value"),        
		  
		(else_try),
			#diploma_event_amout
			(val_add, ":overlay", 1),
			(eq, ":object", ":overlay"), 
			(faction_set_slot,"fac_mod_variables",slot_Mod_diploma_event_amout,":value"),   
		...
		(else_try),
			...
			(try_begin),
			  ...
			  (else_try),
				...
				(this_or_next|eq, ":object", ":overlay_2"),
				(eq, ":object", ":overlay"), 	  
				(overlay_set_text, "$g_presentation_obj_banner_selection_1", "str_set_default_d"),       
			...
			(else_try),
				...
				(this_or_next|eq, ":object", ":overlay_2"),
				(eq, ":object", ":overlay"), 	  
				(overlay_set_text, "$g_presentation_obj_banner_selection_1", "str_polearm_broken_chance_factor_d"),       
			...
			(else_try),
				...
				(this_or_next|eq, ":object", ":overlay_2"),
				(eq, ":object", ":overlay"),
				(overlay_set_text, "$g_presentation_obj_banner_selection_1", "str_diploma_distance_d"),       
			...
			(else_try),
				...
				(this_or_next|eq, ":object", ":overlay_2"),
				(eq, ":object", ":overlay"),
				(overlay_set_text, "$g_presentation_obj_banner_selection_1", "str_diploma_war_rate_d"),      
			...
			(else_try),
				...
				(this_or_next|eq, ":object", ":overlay_2"),
				(eq, ":object", ":overlay"),
				(overlay_set_text, "$g_presentation_obj_banner_selection_1", "str_diploma_event_amout_d"),   

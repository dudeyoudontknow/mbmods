...
# LANCE USAGE BEGIN
   ...
   [
      ...
      (try_for_agents, ":agent"),
        ...
        (try_begin),
          (this_or_next|is_between, ":troop_id","trp_swadian_militia","trp_swadian_skirmisher"),#yifeng pikemen
          (this_or_next|is_between, ":troop_id","trp_summer_footman","trp_summer_pikeman1"),
          (this_or_next|is_between, ":troop_id","trp_nord_footman","trp_nord_warrior"),
          (this_or_next|is_between, ":troop_id","trp_rhodok_tribesman","trp_rhodok_trained_spearman"),
          (this_or_next|is_between, ":troop_id","trp_sarranid_footman","trp_sarranid_skirmisher"),
          (this_or_next|is_between, ":troop_id","trp_sarranid_spearman","trp_sarranid_horseman"),
          (this_or_next|is_between, ":troop_id","trp_ming_infantry","trp_ming_crossbowman"),
          (this_or_next|is_between, ":troop_id","trp_england_sharpshooter","trp_england_messenger"),
          (this_or_next|is_between, ":troop_id","trp_spain_footman","trp_spain_messenger"),
          (this_or_next|is_between, ":troop_id","trp_japan_tribesman","trp_japan_lancer"),
          (this_or_next|is_between, ":troop_id","trp_poland_lithuania_skirmisher","trp_poland_lithuania_horseman"),
          (this_or_next|is_between, ":troop_id","trp_taiga_bandit","trp_taiga_bandit1"),
#          (this_or_next|is_between, ":troop_id","trp_nord_footman","trp_nord_warrior"),
#          (this_or_next|is_between, ":troop_id","trp_nord_footman","trp_nord_warrior"),
#          (this_or_next|is_between, ":troop_id","trp_nord_footman","trp_nord_warrior"),
          ...
          # Is it a lance?
          (neg|is_between, ":wielded", "itm_pike","itm_wooden_shield"), # adjust as needed
          #(neg|is_between, ":wielded", "itm_iron_staff","itm_light_lance"), # adjust as needed
          #(neg|is_between, ":wielded", "itm_two_handed_axe","itm_sword_medieval_a"), # adjust as needed
          ...
          # nothing.
          (try_for_range,":item","itm_pike","itm_wooden_shield"), # adjust as needed
            (gt, ":item", 0),
    ...
    [
      ...
      (try_begin),
        ...
        (try_for_range, ":cur_slot", 0, 4),
          ...
          (else_try),
            (item_slot_eq, ":cur_weapon", slot_item_couchable, 1),
            (val_add, ":has_lance", 1),
          (else_try),
...
#          (team_get_movement_order, ":movement_order", ":agent_team", ":agent_division"),
          ...
          (else_try), 
            ...
            (gt,":agent_pike",0),
            (item_get_slot, ":pike_length", ":weapon_item", slot_item_length),
          ...
          (else_try),
            ...
            (else_try), 
              (gt,":agent_1_hand",0),
              (gt,":agent_shield",0),
              (call_script, "script_cf_agent_check_enemies_nearby", ":agent_no", 100),#yifeng
              (agent_set_wielded_item, ":agent_no", ":agent_1_hand"),
              (agent_set_wielded_item, ":agent_no", ":agent_shield"),
            (else_try), 
              (gt,":agent_1_hand",0),
              #(val_div, ":pike_length", 3),
              (call_script, "script_cf_agent_check_enemies_nearby", ":agent_no", 250),
              (agent_set_wielded_item, ":agent_no", ":agent_1_hand"),
            (try_end),    
          (else_try),
            (eq,":agent_spear",0),
        ...
        (else_try),
          ...
          (try_begin),
            ...
            (try_begin),
              (gt, ":weapon_item", 0),
              # couchable weapon
              (item_slot_eq, ":weapon_item", slot_item_couchable, 1),
              (try_for_range, ":cur_slot", 0, 4),
                (agent_get_item_slot, ":cur_weapon", ":agent_no", ":cur_slot"),
                (gt, ":cur_weapon", 0),
                (item_get_type, ":i_type", ":cur_weapon"),
                ...
                (item_slot_eq, ":cur_weapon", slot_item_couchable, 0),
                (agent_set_wielded_item, ":agent_no", ":cur_weapon"),
              (try_end),
            (try_end),
          (else_try),
            ...
            (try_begin),
              (gt, ":weapon_item", 0),
              # not couchable weapon
              (item_slot_eq, ":weapon_item", slot_item_couchable, 0),
              (try_for_range, ":cur_slot", 0, 4),
                (agent_get_item_slot, ":cur_weapon", ":agent_no", ":cur_slot"),
                (gt, ":cur_weapon", 0),
                # couchable weapon
        ...
        (try_for_agents,":agent"),
           ...
           (try_for_range,":spear","itm_pitch_fork","itm_wooden_shield"),
              ...
              (else_try),
                 ...
                 (assign,":continue",0),
              (else_try),
                 (eq,":spear","itm_pike560"),
                 (assign,"$spear_dist",560),
              (else_try),
                 (eq,":spear","itm_pike400"),
                 (assign,"$spear_dist",400),
              (else_try),
                 (eq,":spear","itm_pike500"),
                 (assign,"$spear_dist",500),
              (try_end),
           (try_end),
           (eq,":continue",1),
           (assign,":victim",-1),
...
## Polearm broken changed by windmelodie
common_dealer_lance_break =  (
		...
		(faction_slot_eq,"fac_mod_variables",slot_Mod_polearm_broken,1),
		
		(agent_is_human, ":dealer_agent"),
		(agent_get_attack_action, ":dealeraction", ":dealer_agent"),
		(eq,":dealeraction",3),
		(agent_get_wielded_item,":breakweapon",":dealer_agent",0),   
		(gt,":breakweapon",2),
		(item_get_type, ":weapontype", ":breakweapon"),
		(eq,itp_type_polearm,":weapontype"),
		(is_between,":breakweapon","itm_shortened_spear","itm_bec_de_corbin_a"),
		
		(assign,":report",0),
		(agent_get_troop_id,":inflicted_troop", ":inflicted_agent"),
		(agent_get_troop_id,":dealer_troop", ":dealer_agent"),
		(str_store_troop_name, s20, ":inflicted_troop"),
		(str_store_troop_name, s21, ":dealer_troop"),
		(str_store_item_name, s22, ":breakweapon"),
		(assign, reg20, ":inflicted_damage"),
		(agent_get_horse,":dealermounted",":dealer_agent"),

		(try_begin),
						
			(store_div,":weaponbreakchance",":inflicted_damage",20),
			(val_add,":weaponbreakchance",10),
						
			(try_begin),
				(ge,":dealermounted",0),
				(set_fixed_point_multiplier, 10),
				(agent_get_speed, pos1, ":dealermounted"),
				(position_get_y,":speed",pos1),
				(val_div,":speed",6),
				(val_add,":weaponbreakchance",":speed"),
			(try_end),
			
			(faction_get_slot,":factor","fac_mod_variables",slot_Mod_polearm_broken_chance_factor),
			(val_mul,":weaponbreakchance",":factor"),
			(val_div,":weaponbreakchance",100),
			
			(store_random_in_range, ":random", 0, 100),
			(try_begin),
				(eq,":dealer_troop","trp_player"),
				(assign,":report",1),
				(val_div,":weaponbreakchance",2),
				(faction_slot_eq,"fac_mod_variables",slot_Mod_polearm_broken_report,1),
				(assign,reg19,":weaponbreakchance"),
				(display_message, "str_polearm_broken_chance",0xFF9999),
			(else_try),
				(is_between,":dealer_troop",companions_begin,pretenders_end),
				(val_div,":weaponbreakchance",2),
				(assign,":report",1),
			(try_end),
			
			(try_begin), 
				(gt,":weaponbreakchance",":random"),
				(agent_unequip_item,":dealer_agent",":breakweapon"),
				(play_sound_at_position, "snd_shield_broken", pos0),
				(particle_system_burst, "psys_dummy_smoke", pos0, 3),
				#(particle_system_burst, "psys_dummy_straw_big", pos0, 100),      
				(particle_system_burst, "psys_dummy_straw_big", pos0, 50),      
				(agent_unequip_item, ":dealer_agent", ":breakweapon"),
				(eq,":report",1),
				(display_message, "str_polearm_broken_message",0xFF6464),
				(lt,":dealermounted",0),
				(agent_set_animation, ":dealer_agent", "anim_strike_chest_front"),

			(try_end),
		(try_end),          
      ], [])

## Ellis add volly fire
   ...
   6, 0, 0, [],#Every six seconds
    ...
    (try_for_agents, ":cur_agent"),
      (try_begin),
        ...
        (neg|is_between,":horse_type","itm_camel","itm_charge_france"),
		(neg|is_between,":horse_type","itm_yf_ydzx","itm_fysg_bin_shazei01"),
		#       (is_between,":horse_type","itm_camel","itm_charge_france"),
        ...
        (try_for_agents,":enemy_horse"),
            ...
            (neg|is_between,":enemy_horse_type","itm_arabian_horse_a","itm_courser"),
            (neg|is_between,":enemy_horse_type","itm_arabian_horse_b","itm_hunter"),
            (neg|is_between,":enemy_horse_type","itm_warhorse_sarranid","itm_warhorse_steppe"),

            (agent_get_position,pos1,":enemy_horse"),
            (get_distance_between_positions,":dist",pos1,pos2),#In CM
            (le,":dist",2000),#Within 35m
...
## ZZ call_horse
call_horse_trigger = (0, 0, 0, [(key_clicked, key_m)], [
      (get_player_agent_no,":agent"),
      (agent_get_horse,":horse",":agent"),
      (neg|gt,":horse",0),
      (agent_get_slot,":horse",":agent",slot_agent_horse),
      ...
      (else_try),
		  (store_skill_level ,":riding_skill",skl_riding,"trp_player"),
		  (ge,":riding_skill",5),
          (assign, ":short_dist", 100000),
          (assign, ":chosen_horse",0),
          (assign, ":rider",0),      
          (try_for_agents, ":another_horse"),
              (neg|agent_is_human, ":another_horse"),
              (agent_is_alive,":another_horse"),      
              (agent_get_rider, ":rider",":another_horse" ),
              (agent_get_position, pos1, ":agent"),      
              (try_begin),
                  (lt, ":rider", 0),
                  (agent_get_position, pos2, ":another_horse"),             
                  (get_distance_between_positions, ":dist", pos2, pos1),
                  (assign, reg1, ":dist"),           
                  (try_begin),
                      (lt, ":dist", ":short_dist"),        
                      (assign, ":short_dist", ":dist"),
                      (assign, reg2, ":short_dist"),         
                      (assign, ":chosen_horse", ":another_horse"),
                   (try_end),
              (try_end),       
          (try_end),
          (agent_set_scripted_destination, ":chosen_horse", pos1, 0),      
      (try_end),      
    ])

init_player_horse = (0.2, 0, ti_once, [], [
      (get_player_agent_no,":agent"),
      (agent_get_horse,":horse",":agent"),
      (agent_set_slot,":agent",slot_agent_horse,":horse"),
    ])
## ZZ call_horse
...
common_battle_order_panel_tick = (
  ...
  [
    (try_begin),
      ...
      (neg|is_presentation_active, "prsnt_mini_map"),	
      (neg|is_presentation_active, "prsnt_caba_order_display"),#Windmelodie pbod caba order
      (start_presentation, "prsnt_mini_map"),
    (try_end),
    (try_begin),
    ...
    (else_try),
	  ...
	  (eq, "$minimap_state",2),	  
      (call_script, "script_update_battle_status_label"),		  
    (try_end),
    ])
## ZZ minimap end
...
##          (agent_get_team, reg3, ":dead_agent_no"),          
      ...
      (1, 0, 5, [(lt,"$attacker_reinforcement_stage",4),#yifeng change from 2
                 (store_mission_timer_a,":mission_time"),
                 (ge,":mission_time",10),
                 (store_normalized_team_count,":num_attackers", 1),
                 (lt,":num_attackers",6)],
...
##          (agent_get_team, reg3, ":dead_agent_no"),          
      ...
      (1, 0, 5, [(lt,"$defender_reinforcement_stage",20),#zs:lead_charge_more_reinforcement: 2 => 5# yifeng 5 to 20
                 (store_mission_timer_a,":mission_time"),
                 (ge,":mission_time",10),
                 (store_normalized_team_count,":num_defenders", 0),
                 (lt,":num_defenders",6)],
           [(add_reinforcements_to_entry,0,6),(val_add,"$defender_reinforcement_stage",1)]),
      (1, 0, 5, [(lt,"$attacker_reinforcement_stage",20),#zs:lead_charge_more_reinforcement: 2 => 5 yifeng 5 to 20
                 (store_mission_timer_a,":mission_time"),
                 (ge,":mission_time",10),
                 (store_normalized_team_count,":num_attackers", 1),
                 (lt,":num_attackers",6)],
...
##  ),
 ...
 #yifeng add from 1429
############################################### MT Towns 1429 generique 
  (
    "town_quartiers",0,-1,
    "Quartier",
    [(0,mtef_scene_source|mtef_team_0,af_override_horse,0,1,pilgrim_disguise),
...
## ZZ manor begin
  (
    ...
    [
      ...
      (0.1, 0, 0, [(key_clicked,key_b)],
       [
	   (get_player_agent_no,":player"),
	   (agent_get_position,pos1,":player"),
	   (set_spawn_position, pos1),
	   (spawn_scene_prop, "spr_ship"),
	   (display_message,"@XXXXXXXXXXXXXXXXXXXXXXXXXXXXxxxxx"),	 	   
	   ]),	  
    ]),
		
		
## ZZ Sea Battle begin seabattle
  (
    "sea_battle",mtf_battle_mode,charge,#海战-追逐
    "You lead your men to battle.",
    [
     (1,mtef_defenders|mtef_team_0|mtef_use_exact_number,af_override_horse,aif_start_alarmed,33,[]),##因为只有一条船,所以限制单方首次出场人数上限为33.
    ...
    [
      ...
      (ti_before_mission_start, 0, 0, [],
       [
		...
		(assign, "$water_battle", 1),#海战，用于屏蔽native的战斗地图
		(assign, "$temp", 1),
		(assign, "$temp_2", -1),
		(assign, "$temp_3", 1),
		(assign, reg11, 1),#entry_11 转向阀
		(assign, reg12, 1),#entry_12 转向阀
		(assign, reg13, 1),#entry_13 转向阀
		(assign, reg14, 1),#entry_14 转向阀
		(assign, reg49, -1),#停止射击/开火记录
		(assign, reg48, 1),#接触判断
         ]),
      ...
      (try_begin),
        (lt, ":total_enemy_reinforcements", 15),
        (ge, "$defender_reinforcement_stage", 5), #yifeng 2 to 5
        (eq, "$defender_reinforcement_limit_increased", 0),
        (val_add, "$g_defender_reinforcement_limit", 1),                    
        (assign, "$defender_reinforcement_limit_increased", 1),
      (try_end),    
      ...
      (1, 4, ti_once, [(main_hero_fallen)],
          [
#		  		 (display_message, "@XXXXhaizhanchetui"),
			  (assign, "$water_battle", 0),#海战，用于屏蔽native的战斗地图
              (assign, "$pin_player_fallen", 1),
              (str_store_string, s5, "str_retreat"),
              (call_script, "script_simulate_retreat", 10, 20, 1),
              (assign, "$g_battle_result", -1),
...
(  1, 60, ti_once,
  ...
  [
	...
	#	  (neq, "$temp", 3),#接舷战开始后不能主动撤退
		...
		(question_box,"@Select the Tactics:^^^Select 'Yes' for a frontal attack that you will fight hand-to-hand while your ship connecting with the enemy's. ^^Select 'No' for an Outflanking attack that you will move around and fight circuitously."),
		]),
		(ti_question_answered, 0, 0, [],
		[
		(store_trigger_param_1,":answer"),
		...
		(else_try),
			(try_begin),
				(eq,":answer",0),
				(assign,"$temp_2",1),#=1，接触战
			(else_try),
				(assign,"$temp_2",2),#=2，迂回战
			(try_end),
		(try_end),
		]),
      ...
      (1, 7, 0, [#恢复reg48,自动排列恢复
		(eq, reg48, 2),
		],[(assign, reg48, 1)]),

      (1, 2, 3, [#停止/恢复射击命令时防止士兵不换出远程武器。
		(get_player_agent_no, ":player_agent"),
...
#已经死的移动到海底
      (ti_on_agent_killed_or_wounded, 0, 1, [#标记死亡的agent
		(neq, reg48, -1),
        (store_trigger_param_1, ":dead_agent_no"),
	  ...
	  ##物品箱子跟随
       (0, 0, 0, [
		...
		(position_move_z, pos2, 110),###yifeng 箱子高度
...
## ZZ Sea Battle end	
	...
	(
    "dungeon1",mtf_battle_mode|mtf_synch_inventory,charge, ##Dungeons
    "yy",
    [
     ...
     (15,mtef_visitor_source,af_override_horse,0,1,[]),
     (16,mtef_visitor_source,af_override_horse,0,1,[]),
     (17,mtef_visitor_source,af_override_horse,0,1,[]),(18,mtef_visitor_source,af_override_horse,0,1,[]),(19,mtef_visitor_source,af_override_horse,0,1,[]),(20,mtef_visitor_source,af_override_horse,0,1,[]),
...
####yifeng test 1
	(
    "dungeon2",mtf_battle_mode|mtf_synch_inventory,charge, ##Dungeons
    "yyll",
    [
     (0,mtef_scene_source|mtef_team_0,af_override_head|af_override_horse,0,1, []),
     (1,mtef_visitor_source,af_override_horse,0,1,[]),
...
####yifeng test 2
	(
    "dungeon3",mtf_battle_mode|mtf_synch_inventory,charge, ##Dungeons
    "yy22",
    [
     (0,mtef_scene_source|mtef_team_0,af_override_head|af_override_horse,0,1, []),
     (1,mtef_visitor_source,af_override_horse,0,1,[]),
...
####yifeng test 3
	(
    "dungeon4",mtf_battle_mode|mtf_synch_inventory,charge, ##Dungeons
    "yy33",
    [
     (0,mtef_scene_source|mtef_team_0,af_override_head|af_override_horse,0,1, []),
     (1,mtef_visitor_source,af_override_horse,0,1,[]),
...
####yifeng test 4
	(
    "dungeon5",mtf_battle_mode|mtf_synch_inventory,charge, ##Dungeons
    "yy44",
    [
     (0,mtef_scene_source|mtef_team_0,af_override_head|af_override_horse,0,1, []),
     (1,mtef_visitor_source,af_override_horse,0,1,[]),
...
####yifeng test 7
	(
    "dungeon8",mtf_battle_mode|mtf_synch_inventory,charge, ##Dungeons
    "yy77",
    [
     (0,mtef_scene_source|mtef_team_0,af_override_head|af_override_horse,0,1, []),
     (1,mtef_visitor_source,af_override_horse,0,1,[]),
...
####yifeng test 8
	(
    "dungeon9",mtf_battle_mode|mtf_synch_inventory,charge, ##Dungeons
    "yy88",
    [
     (0,mtef_scene_source|mtef_team_0,af_override_head|af_override_horse,0,1, []),
     (1,mtef_visitor_source,af_override_horse,0,1,[]),
...
####yifeng test 9
	(
    "dungeon10",mtf_battle_mode|mtf_synch_inventory,charge, ##Dungeons
    "yy99",
    [
     (0,mtef_scene_source|mtef_team_0,af_override_head|af_override_horse,0,1, []),
     (1,mtef_visitor_source,af_override_horse,0,1,[]),
...
####yifeng test 10
	(
    "dungeon11",mtf_battle_mode|mtf_synch_inventory,charge, ##Dungeons
    "yy10",
    [
     (0,mtef_scene_source|mtef_team_0,af_override_head|af_override_horse,0,1, []),
     (1,mtef_visitor_source,af_override_horse,0,1,[]),
